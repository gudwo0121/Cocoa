...
<script type="text/javascript">
	...
	function categoryChange(e) {
		...
		var level_pField_out = [ "-- 선택 --", "Basic", "Intermediate", "Advanced" ];
					...
					<div class="card px-3"
						...
						<div class="project">
							...
							영역 : <select
								...
								name="pField" disabled id="p_pField" onchange="categoryChange(this)">
							...
							<!-- 수정 확인 -->
							<div align="center">
								<input type="submit" onclick="nullCheck()" value="확 인" class="btn btn-outline-dark"
