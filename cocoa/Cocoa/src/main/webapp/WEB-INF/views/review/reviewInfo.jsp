					...
					<div class="row">
						<div
							...
							<br> <br> <a
								...
								name="proImg"
								src="${contextPath}/downProfileImg?id=${target}"
					...
					<div class="card rcol my-5"
						...
						<div style="border: 1px solid grey;">
							<table style="margin: 0px auto;">
								...
								<tr>
									<td style="float: left;">작성자 : <input type="text" disabled
										id="star" name="star" value="${reviewInfo.writer}"
										style="vertical-align: top; text-align: center; border: none; background-color: #FFEBCD; color: black;"></td>
									<td style="float: left;">평점 : <input type="text" disabled
										id="star" name="star" value="${reviewInfo.rate }점"
										style="vertical-align: top; text-align: center; border: none; background-color: #FFEBCD; color: black;"></td>
									<td colspan="2"></td>
									<c:if test="${isLogOn == true && member.id !=writer}">
									<td style="float: right;"><input type="button" value="수 정">&nbsp;&nbsp;<input
										type="button" value="삭 제"></td>
									</c:if>
								</tr>
								<tr>
