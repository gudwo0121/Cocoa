...
<body style="background-color: #FFEBCD">
	...
	<div class="card rcol my-3"
		...
		<form action="${contextPath}/modRequest" method="post" enctype="multipart/form-data">
			<table
				...
				<tr>
					...
					<td style="text-align: left; vertical-align: top;"><textarea
							rows="10" cols="20" class="form-control" id="rContents" name="rContents" disabled
				...
				<tr>
					...
					<td style="text-align: left;">
						<input type="hidden" name="originalFileName" value="${requestInfo.rImg }" />
						<img id="preview" src="${contextPath}/downRImg?reqNO=${requestInfo.reqNO}"
				...
				<tr>
					<td align="center" colspan="2"><br> 
						<input type="button"
							id="mod_start" class="btn btn-outline-dark" style="background-color: white; color: black;"
							onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
							onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
							value="수 정" />&nbsp;&nbsp;&nbsp; 
						
						<input type="submit"
							id="mod_finish" class="btn btn-outline-dark" style="background-color: white; color: black;"
							onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
							onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
							value="수 정 확 인" />
						
						<input type="button" onclick="yesOrNo()"
							id="del" class="btn btn-outline-dark" style="background-color: white; color: black;"
							onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
							onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
							value="철 회" />&nbsp;&nbsp;&nbsp; 
						
						<input type="button" 
							id="to_list" class="btn btn-outline-dark" style="background-color: white; color: black;"
							onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
							onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
							value="목록으로" onclick="location.href='/cocoa/view_sendReq'" /> <br> <br>
					</td>
				</tr>
			</table>
		</form>
