...
<body style="background-color: #FFEBCD">
			...
			<div class="row gx-5 justify-content-center">
				<div class="col-lg-6">
					<div class="text-center my-5">
						<h1 class="display-5 fw-bolder text-white mb-2">Welcome to Cocoa!</h1>
	...
	<section class="py-5 border-bottom" id="categories">
		<div class="container px-5 my-5">
			<div class="row gx-5 justify-content-center">
				<div class="mb-5 mx-3 px-2 py-2" style="width:300px; height:200px;">
					<div class="mb-3">
						<i class="bi bi-laptop" style='font-size:50px;'></i>
					</div>
					<h2 class="h4 fw-bolder">Project</h2>
					<p>다양한 주제의 프로젝트들이 <br> 여러분을 기다리고 있습니다!<br>원하는 프로젝트에 참여하거나 <br> 직접 만들어 팀원을 모아보세요!</p>
					<a class="text-decoration-none" href="/cocoa/view_projectCate">
						살펴보기 <i class="bi bi-arrow-right"></i>
					</a>
				</div>
				<div class="mb-5 mx-3 px-2 py-2 round" style="width:300px; height:200px;">
					<div
						class="mb-3">
						<i class="bi bi-person-video3" style='font-size:50px;'></i>
					</div>
					<h2 class="h4 fw-bolder">Coaching</h2>
					<p>코딩 공부가 어렵나요?<br>그렇다면 코치의 도움을 받아보세요!<br>디버깅부터 맞춤 지도까지!<br>뛰어난 코치들이 기다리고 있습니다!</p>
