	...
	<div class="card rcol my-3"
		...
		<form action="" method="post">
			<table
				...
				<tr>
					<th colspan="2"
						style="vertical-align: middle; text-align: center; font-size: 20px;">${requestInfo.req}의 요청서</th>
				</tr>
				...
				<tr>
					...
					<td style="text-align: left; vertical-align: top;"><textarea
							rows="10" cols="20" class="form-control" id="" name="rContents" readonly
				...
				<tr>
					...
					<td style="text-align: left;">
						<img id="preview" src="${contextPath}/downRImg?reqNO=${requestInfo.reqNO}&rImg=${requestInfo.rImg}"
				...
				<tr>
					<td align="center" colspan="2"><br> 
						<input type="button"
							id="" class="btn btn-outline-dark" style="background-color: white; color: black;"
						...
						<input type="button" id=""
							class="btn btn-outline-dark" style="background-color: white; color: black;"
							onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
							onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
							value="거 절" />&nbsp;&nbsp;&nbsp; 
						...
						<input type="button" id=""
							...
							onmouseover="this.style.color='white'; this.style.backgroundColor='black';"
							onmouseout="this.style.color='black'; this.style.backgroundColor='white';"
							value="목록으로" onclick="location.href='/cocoa/view_receiveReq'" /> <br> <br>
						</td>
				</tr>
			</table>
		</form>
