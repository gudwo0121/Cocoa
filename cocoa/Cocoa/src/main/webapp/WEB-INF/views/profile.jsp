		...
		<section class="py-5">
			<div class="container main-secction">
				<div class="row" style="flex-wrap: unset;">
					...
					<!-- 우측 내용 : pContents -->
					<div class="card"
						style="width: 40rem; border: 1px solid; background-color: #FFCC99; color: black;">
						<div class="proFile">
							...
							<textarea name="proContents" rows="30" cols="20" id="proContents"
								disabled
								style="border: 1px solid; background-color: #FFCC99; width: 100%; color: black;">${member.proContents}</textarea>
							<hr>
						</div>
						...
						<div class="card-body" style="text-align: center">
							<input type="submit" id="mod_profile"
								class="btn btn-outline-dark" value="수정 확인" /> <a href="/cocoa"
								id="mod_start" class="btn btn-outline-dark">수정하기</a> &nbsp; <input
								type="button" id="cancel" value="취소" onclick="history.go(0)"
